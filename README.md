# Cloud Food Store Client

Cloud Food Store Client or Cloud Food Store Site is a website that allows users to search for products on the marketplace in a convenient way for them and order them.
